...
basic_conversion_rules = {"for": "Pour", "=": "<-", "if": "Si", "==": "=", "while": "Tant que", "until": "jusqu'à",
                          "import": "Importer", "class": "DEFINIR CLASS", "def": "FONCTION", "else:": "sinon:",
                          "elif": "Sinon si", "except:": "EXCEPTION:", "try:": "Essaye:", "pass": "Continue", "in": "Dans",
                          " : ": "faire", "  : ": "alors"}
prefix_conversion_rules = {"=": "SET ", "#F": "Procedure "}
advanced_conversion_rules = {"print": "Ecrire", "return": "RETOURNER", "input": "Lire"}
